...
export const SELECT_IMAGE_FILE_TO_CONVERT = "image-to-icon/SELECT_IMAGE_TO_CONVERT";
export const QUEUE_PENDING_IMAGE_CONVERSION = "image-to-icon/QUEUE_PENDING_IMAGE_CONVERSION";
export const BEGIN_IMAGE_CONVERSION = "image-to-icon/BEGIN_IMAGE_CONVERSION";
export const SET_COMPLETED_IMAGE_CONVERSION = "image-to-icon/SET_COMPLETED_IMAGE_CONVERSION";
export const SET_FAILED_IMAGE_CONVERSION = "image-to-icon/SET_FAILED_IMAGE_CONVERSION";
